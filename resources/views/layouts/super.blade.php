...
<head>
    ...
    <title>{{ config('app.name', 'LMS Platform') }} - Super Admin</title>
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="fixed inset-y-0 left-0 w-64 bg-gray-800 text-white">
            ...
            <nav class="mt-5">
                <a href="{{ route('super.dashboard') }}" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <div class="relative">
                                    <input type="text" class="w-64 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Search...">
                                </div>
                            </div>
                        </div>
