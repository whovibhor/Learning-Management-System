    ...
    <nav x-data="{ open: false, sidebarOpen: true }" class="bg-white border-b border-gray-100">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link href="#" :active="request()->routeIs('admins')">
                    {{ __('Admins') }}
                </x-responsive-nav-link>
                ...
                <x-responsive-nav-link href="#" :active="request()->routeIs('achievements')">
                    {{ __('Achievements') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link href="#" :active="request()->routeIs('logs')">
                    {{ __('Logs') }}
                </x-responsive-nav-link>
            </div>
